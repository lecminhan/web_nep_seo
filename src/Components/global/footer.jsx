    ...
    <Box sx={{ maxWidth: "1200px", mx: "auto", px: 2 }}>
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={3}>
          ...
          >
           Tổng kho Nẹp Nhôm <br/> – Nẹp Inox Trang Trí Nội Thất Đà Nẵng.<br/> Chuyên cung cấp nẹp nhôm anode,<br/> nẹp inox 304, nẹp đồng thau, nẹp nội thất, <br/>nẹp trang trí,nẹp chống trơn, nẹp xây dựng <br/>  số lượng lớn
          </Typography>
          <Typography
            variant="body2"
